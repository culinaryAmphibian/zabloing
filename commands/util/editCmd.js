...
let errEmbed = {color: global.orangeCol, title: 'error', description: 'this guild doesn\'t have commands in the first place!', footer: global.footer};
let succEmbed = {color: global.blueCol, title: 'success', description: 'the ', footer: global.footer};
