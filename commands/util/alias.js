...
let errEmbed = {color: global.orange, title: 'error', description: 'you need to have the permissions to manage messages to create aliases.', footer: global.footer};
