...
let suggestEmbed = {color: global.green, title: '', description: '', footer: global.footer};
...
module.exports =
{
    ...
    execute(message, args, bot)
    {
        ...
        if ((new Date().getTime()) - UserJSON[message.author.id].lastSuggest < (1000 * 60 * 10)) return message.channel.send({embeds:[errEmbed]}); 
