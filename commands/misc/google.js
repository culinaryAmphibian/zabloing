...
let errEmbed = {color: global.orange, title: 'error', description: 'please specify a search query', footer: global.footer};
...
module.exports =
{
    ...
    {
        let embed = {color: global.blue, title: 'google search results for ', description: '', fields: [], footer: global.footer};
        let query = args.slice(1).join(" ");
        if (!query) return message.channel.send({embeds:[errEmbed]});
