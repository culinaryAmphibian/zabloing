let errEmbed = {color: global.orange, title: 'error', description: 'you don\'t have the perms!', footer: global.footer};
...
module.exports =
{
    ...
    execute(message, args)
    {
        ...
        if (!message.guild.me.hasPermission("MANAGE_MESSAGES")) return message.channel.send({embeds:[errEmbed]});
        ...
        if (isNaN(args[1]) || num.includes('-') || num.includes('.') || num == 0 ) return message.channel.send({embeds:[errEmbed]});
